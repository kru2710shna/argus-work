...
foreach(_cmake_expected_target IN ITEMS fatrop::fatrop)
...
# Create imported target fatrop::fatrop
add_library(fatrop::fatrop SHARED IMPORTED)
...
file(GLOB _cmake_config_files "${CMAKE_CURRENT_LIST_DIR}/fatropTargets-*.cmake")
